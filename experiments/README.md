...
* [NetflixPrize](https://www.kaggle.com/datasets/netflix-inc/netflix-prize-data): download and extract it in `experiments/datasets/netflixprize`
...
- \[7\]: toy_dataset_5k_500k
- \[8\]: toy_dataset_10k_100k
- \[9\]: toy_dataset_10k_500k
- \[10\]: toy_dataset_10k_1M
- \[11\]: toy_dataset_10k_5M
- \[12\]: toy_dataset_10k_15M
- \[13\]: toy_dataset_10k_30M
- \[14\]: toy_dataset_50k_500k
- \[15\]: toy_dataset_100k_500k
- \[16\]: toy_dataset_100k_1M
- \[17\]: toy_dataset_100k_5M
- \[18\]: toy_dataset_100k_15M
- \[19\]: toy_dataset_100k_30M
- \[18\]: ml-100k
- \[19\]: ml-1m
- \[20\]: ml-10m
...
Originally, the experiments were conducted on a workstation equipped with an NVIDIA RTX 3090 GPU and an Intel Xeon E5-2630 v4 CPU, with and without GPU acceleration. If executed in the same architecture mentioned, it is expected to obtain the results shown below
...
<img src="/docsrc/source/_static/items_lints_enhance_and_time.svg" width="75%">

### LinTS - Toy Dataset (500k Interactions): Predicted Elapsed Time (s) vs. Predicted Number of Items

<img src="/docsrc/source/_static/items_lints_pred.svg" width="75%">

### LinTS - Toy Dataset (1k Items): Elapsed Time (s) vs. Number of Interactions

<img src="/docsrc/source/_static/interactions_lints_enhance_and_time.svg" width="75%">

### LinTS - Toy Dataset (1k Items): Predicted Elapsed Time (s) vs. Predicted Number of Interactions

<img src="/docsrc/source/_static/interactions_lints_pred.svg" width="75%">
